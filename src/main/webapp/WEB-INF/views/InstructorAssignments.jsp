														...
														<tr>
															...
															<td><form name="grades" action="?grades"
																	...
																	<input type="hidden" name="employee_id"
																		...
																		name="assignment_id" value="${in.assignment_id }" /> <input
																		type="text" name="grade" placeholder="${in.grade}" />
						...
						<c:otherwise>
							...
							<div class="tab-pane fade active in" id="class${cl.class_id}">
								<div class="tabbable">
									...
									<div class="tab-content">
										<div class="tab-pane fade in active" id="sub${count+3}">
											<div>
												<table class="table">
													<tr>
														<th>Assignment Name</th>
												...
												<table class="table">
													...
													<c:forEach items="${todoAssignments}" var="in">
														<tr>
															...
															<td><form name="assignment" action="?assignment"
																	method="POST">
																	<input type="hidden" name="employee_id"
																		value="${in.employee_id }" /> <input type="hidden"
																		name="assignment_id" value="${in.assignment_id }" /> <input
																	...
																	<input type="hidden" name="module_id"
																		value="${in.module_id}" /> <input type="hidden"
