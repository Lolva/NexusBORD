...
public class LoginController {
    ...
    public Object submit(Model model, @ModelAttribute("login") UserLogin login, HttpSession session) {
        ...
        if (login != null && login.getUsername() != null & login.getPassword() != null) {
            ...
            if (dao.checkPassword(login)) {
                ...
                if (dao.isEnrolled(login)) {
                    ...
                    return new ModelAndView("redirect:/Nexus.html"); // Send the user to the main page
