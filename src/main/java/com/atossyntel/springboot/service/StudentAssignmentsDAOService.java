...
//	} 
	...
	public void submitAssignment(String submitDate, int grade, MultipartFile file, String assignmentID, String empID) {
        ...
        String sqlQuery = "UPDATE submissions SET submission_date= TO_DATE(?,'YYYY-MM-DD'), grade= ?, file_name= ?, file_type= ?"
        		+ "WHERE assignment_id=? and employee_id=?"; 
        jTemplate.update(sqlQuery, submitDate, grade, fileName, fileType, assignmentIdPlaceholder, empID);
