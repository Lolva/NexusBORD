...
<body>
  <header>
    ...
    <fieldset style="width: 90%; margin:auto; height: 520px; background-color: white;">
   	...
   	<form method="POST">
   		Class ID:<input type="text" name="class_Id" id="classid" placeholder="Enter Class ID">
   		<br>
   		Course ID:<input type="text" name="course_Id" id="courseid" placeholder="Enter Course ID">
   		<br>
   		Capacity:<input type="text" name="capacity" id="capacity" placeholder="Enter Capacity">
   		<br>
...
<br>
	...
	You entered the following details:<br>
        Class ID: ${classBean.class_id}<br>
        Course ID: ${classBean.course_id}<br>
        Capacity: ${classBean.capacity}<br>
        <hr>
   	</form>
   	</fieldset>
